      ...
      <div style={{ display: "flex", minHeight: "80vh" }}>
        <div
          style={{
            ...
            alignItems: "center",
            backgroundImage: 'url("/assets/images/backgroung.png")',
        ...
        >
          ...
          >
            <h2 style={{ fontSize: "18px" }}>
              Sign in to the Kenya National Terminology Services
            </h2>
          </Box>
          <br></br>
          <div
          ...
          >
            <div style={{ marginBottom: "20px", textAlign: "center" }}>
                ...
                <div>
                  ...
                  {showSignInButton && (
                    <button
                      ...
                      onMouseOver={(e) =>
                        (e.target.style.backgroundColor = "#34ebe5")
                      }
                      onMouseOut={(e) =>
                        (e.target.style.backgroundColor = "#1651B6")
                      }
                    >
                      Sign in
                    </button>
              ...
              <div style={{ marginBottom: "10px", fontSize: "16px" }}>
                ...
                <a href="/auth/register">Request Account</a>
              </div>
            </div>
          </div>
        </div>
